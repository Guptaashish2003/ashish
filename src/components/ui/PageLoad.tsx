...
import { PageLoadProps } from "@/_types/interfaces"
  ...
  return (
    ...
    >
      <div className="p-4 md:p-10 flex flex-col md:justify-between max-md:gap-8 w-full h-full">
        <span className="font-semibold text-white/40">ArPortfolio</span>
        <div className="flex flex-col max-md:justify-between max-md:h-full">
          <p className="text-3xl md:text-5xl w-full md:w-2/5">
          I develop full-stack web applications and production-level websites with high efficiency.</p>
